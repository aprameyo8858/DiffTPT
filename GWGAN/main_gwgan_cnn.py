...
save_fig_path = 'out_rasgw_f_5000' + model
...
for epoch in range(num_epochs):
    ...
    for it, (image, _) in enumerate(dataloader):
        ...
        #loss = sgw_gpu_original(D_x.to('cuda'), D_g.to('cuda') ,'cuda',nproj=50000,tolog=False,P=None)
        loss = rasgw_gpu(f_x.to('cuda'),f_g.to('cuda') ,'cuda',nproj=5000,tolog=False,P=None)
